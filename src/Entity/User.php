...
class User implements UserInterface
{
     ...
     * @Assert\NotBlank(message="Veuillez saissir votre email")
     * @Assert\Email(message = "The email '{{ value }}' n est pas valide." )
     */
     ...
     * @ORM\Column(type="datetime_immutable")
     */
    private \DateTimeImmutable $accountMustBeVerifeidBefore;
    ...
    public function __construct()
    {
        ...
        $this->accountMustBeVerifeidBefore = (new \DateTimeImmutable('now'))->add(new \DateInterval("P2D"));
    }
    ...
    public function setAccountMustBeVerifeidBefore(\DateTimeImmutable $accountMustBeVerifeidBefore): self
    {
        $this->accountMustBeVerifeidBefore = $accountMustBeVerifeidBefore;
